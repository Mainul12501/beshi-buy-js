            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 ">
                    <div class="shop_title">
                        <h4 class="text-primary">Latest Products</h4>
                    </div>
                    <div class="parent-div" style="min-height: 200px">
{{--                        @if(isset($products))--}}
...
@section('extra-js')
    ...
    <script src="{{ asset('/') }}front/page-js/latest-products-page/latest-products.js"></script>
@endsection
