                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="{{route('manage-slider')}}" class="text-warning">Mange Slider</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card  border">
                        <div class="card-header bg-dark text-white font-16" style="font-family:'Century Gothic';padding: 10px">Slider Info</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('new-slider')}}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"  style="padding: 1.25rem"/>
                                </div>
                                <div class="form-group">
