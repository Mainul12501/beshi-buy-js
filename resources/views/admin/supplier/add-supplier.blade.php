                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="{{route('manage-supplier')}}" class="text-warning">Mange Supplier</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card  border">
                        <div class="card-header bg-dark text-white font-14" > Supplier Info</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('new-supplier')}}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Category Name :</label>
                                    <select name="category_id" class="form-control" id="subCate" style="height:45px">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="supName" name="name" onblur="supplierCode()"  style="padding: 1.25rem"/>
                                </div>
                                <div class="form-group">
                                    <label for="code">Supplier Code :</label>
                                    <input type="text" class="form-control" id="supCode" name="code" style="padding: 1.25rem"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" name="phone"   style="padding: 1.25rem"/>
                                </div>
                                <div class="form-group">
