            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card  border">
                        <div class="card-header bg-dark text-white font-16">SubCategory Info</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('new-subcategory')}}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sub_category_name"  style="padding: 1.25rem"/>
                                </div>
                                <div class="form-group">
                                    <label for="sub_category_description">Description :</label>
                                    <textarea  class="form-control" name="sub_category_description" style="height: 100px"></textarea>
                                </div>
                                <div class="form-group">
