                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card  border">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update-brand')}}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$brand->name}}"  style="padding: 1.25rem"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" name="image"   accept="image/*" />
                                        @isset($brand->image)
                                            <img src="{{asset($brand->image)}}" style="width: 40px;height: 40px"/>
                                        @endisset
                                    <span class="text-danger font-12">Only support jpg/jpeg/webp image file.</span>
                                </div>
                                <div class="form-group">
                                    <label for="status">Status : </label>
                                    <input type="radio" name="status" class="ml-2" {{$brand->status == 1 ? 'checked' : ''}} value="1"/> Active
                                    <input type="radio" name="status" class="ml-2" {{$brand->status == 0 ? 'checked' : ''}} value="0"/> Inactive
                                </div>
                                <div class="form-group">
